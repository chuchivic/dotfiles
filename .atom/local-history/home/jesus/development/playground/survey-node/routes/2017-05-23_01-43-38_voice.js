...
exports.recorded = function(request, response) {
    ...
    speechClient.recognize(recordingUrl, speechRequest)var VoiceResponse = require('twilio').twiml.VoiceResponse;
var SurveyResponse = require('../models/SurveyResponse');
var survey = require('../survey_data');
// Imports the Google Cloud client library
const Speech = require('@google-cloud/speech');
...
exports.interview = function(request, response) {
    ...
    SurveyResponse.advanceSurvey({
        ...
        if (question.type === 'text') {
            ...
            /*twiml.record({
                recordingStatusCallback: '/voice/' + surveyResponse._id + '/record/' + questionIndex
